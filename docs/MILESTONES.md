...
| EM-5 | Implement the replayable bulk-input live scanner without UI | 🔄 Contract `Proposed`, checkpoint-price parity diagnostic complete 2026-08-28 — 18/18 real live observations vs. real historical candle-open, max 0.0685% diff, negligible frozen-model impact; PARITY ACCEPTABLE recommended, Owner decision + contract `ACCEPTED` outstanding before scanner implementation begins |
