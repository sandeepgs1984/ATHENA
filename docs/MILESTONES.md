...
| **DT-3** Tab restructuring (5 tabs) + spacing polish | Split "Decision History" into Response (Journal/Outcome) + History (Timeline + Analogs); whitespace/hierarchy polish across Trade Plan/Analysis/Market Context — no content changes | 🔄 In progress |
