...
- Dashboard assets: `9.204.0` after MP-NX6C Morning Triage Scan UX. Morning
  ...
  MP-RV7 subsequently authorized 2026-09-13: see
  `docs/design/MY-PORTFOLIO-RV7-VALIDATION.md`. Actual assembled dashboard
  runs against synthetic API fixtures via `tests/browser/portfolio-validation.cjs`.
  No live portfolio writes. Responsive corrections live separately in
  `05d-my-portfolio-responsive.css`; do not mix geometry into typography.
  Below 920px, use the compact navigation rail and flowing toolbars; column
  headings remain sticky. Desktop sticky behavior is preserved. Export is
  viewport-bounded with explicit dismissal. Assets 9.232.0.
