...
| `docs/research/PS-P0-PORTFOLIO-SYNC-DISCOVERY-REPORT.md` + `docs/research/PS-P1-PORTFOLIO-CONTRACT-DESIGN.md` + `docs/research/PS-P2-PORTFOLIO-IMPORT-RECONCILIATION.md` | Portfolio Sync / My Portfolio discovery, frozen contract design, and import/reconciliation implementation: isolated source of truth, CSV/XLSX preview, canonical symbol resolution, atomic confirmation, freshness/provenance, nullable methodology fields, and 20-column Portfolio Snapshot DTO | Starting or reviewing any My Portfolio / Portfolio Sync milestone; confirm current PS status in `docs/MILESTONES.md` first |
