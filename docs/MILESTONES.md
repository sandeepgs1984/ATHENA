...
| MP-RV3 | Clearer investment/export/unavailable-filter copy and overlap caption; Owner-approved in-place filtering with explicit View holdings, live match counts and pinned exceptions; calculation/filter contracts unchanged | 🔄 Ready for Owner review 2026-09-12; behavior test, JS syntax and new-test lint pass; full suite 4018 passed, one existing macOS launcher failure; live UI verification pending |
