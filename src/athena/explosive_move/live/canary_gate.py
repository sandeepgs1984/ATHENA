...
from athena.explosive_move.live.evidence_assembly import assemble_candidate_row
    ...
    *,
    ...
    for iid in mature_instrument_ids:
        ...
        common = dict(
            ...
            historical_checkpoint_volumes=(), regime_row=None,
        )
    ...
    if mismatches:
        return HardInvariantOutcome("CHECKPOINT_BOUNDARY_REGRESSION", False, "; ".join(mismatches))
    return HardInvariantOutcome(
        ...
        for checkpoint in checkpoints:
            ...
            for replica in ("a", "b"):
                ...
                result = run_scan_cycle(
                    ...
                    collect_checkpoint_prices=collector, now=lambda ci=checkpoint_instant: ci,
                )
            ...
            checkpoint_prices_by_checkpoint[checkpoint] = collector(
                instrument_ids=mature_ids, checkpoint_instant=checkpoint_instant,
            )[0]

            boundary_checks.append(_check_checkpoint_boundary_matches_real_candle(
                ...
                tzinfo=tzinfo, daily_bars_by_symbol=daily_bars_by_symbol,
            ))
