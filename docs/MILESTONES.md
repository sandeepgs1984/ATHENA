...
| MP-NX1 | My Portfolio Action Queue and Smart Filters — presentation-only morning triage over already loaded holdings/snapshot fields: Portfolio Command Dashboard attention counts, Action Queue list scope, and Smart Filters for Status / Daily Review / Next Action / Trend / Setup / P&L state / currentness / evidence availability; Near Trigger / Near Support / Fresh Breakout remain unavailable pending owner-approved threshold semantics; no methodology, interpretation-version, export, sync, or privacy-contract change | 🔄 Implementation complete 2026-09-07 — ready for Owner/Chief Architect review |
