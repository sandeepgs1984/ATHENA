...
| [DarvaX validation evidence](docs/design/DARVAX-VALIDATION-EVIDENCE.md) | DX-5 — does the methodology earn its label? (No: 82 trading days vs a 500-day floor) | 🔄 Ready for review |
| [Symbol universe investigation](docs/design/SYMBOL-UNIVERSE-INVESTIGATION.md) | Why the scanner universe is 528 symbols, and the proposal for scanner-specific universes | 🔄 Proposed (ADR-011) |
| [UX Roadmap agent handoff](docs/ATHENA-DARVAX-UX-ROADMAP-HANDOFF.md) | How another AI agent should pick up the UX roadmap: mandatory workflow, hard invariants, and surface-specific gotchas paid for the hard way | Active |
| [ATHENA & DarvaX UX Roadmap](docs/design/ATHENA-DARVAX-UX-ROADMAP.md) | 29 advisory-dashboard UX improvement ideas across both surfaces, surveyed against what already exists — a menu for the owner, nothing scheduled | Proposed |
| [ATHENA-TECHNICAL-ARCHITECTURE](docs/ATHENA-TECHNICAL-ARCHITECTURE.md) | Complete implementation reference — backend/frontend stack, module map, security, testing, ops, verified against the running code | Active |
