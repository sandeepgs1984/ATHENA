...
class OpeningRangeEngine:
    ...
    def assess(
        ...
        *,
        ...
        # ID-4: the canonical-slot filter itself is now the shared
        # `athena.session.canonical_slot_candles` primitive (promoted out of
        # this class so `RelativeStrengthEngine` reuses the identical
        # authority rather than a second copy) -- behavior unchanged.
        canonical = canonical_slot_candles(
